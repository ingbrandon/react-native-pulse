...
export default class Pulse extends Component {
    ...
    render(){
        ...
        const containerStyle = {width: maxDiameter, height: maxDiameter,alignSelf:'center'};
            ...
            <View style={wrapperStyle}>
                {started &&
                    <View style={containerStyle}>
                        ...
                        {image &&
                            <View style={{zIndex:2,flex:1,justifyContent:'center',backgroundColor:'transparent'}}>
                              <Image
                                  style={image.style}
